...
const ModalSlide = ({ image, text1, text2, text3, text4, hashTags, tags }) => {
	...
	return (
		<div className="grid grid-cols-[60%_40%] z-[202] w-full h-[100%] justify-center items-center gap-0">
			<img className="h-full object-cover" src={image} alt="modal product img" />
			{/* <div className="h-full w-full bg-pink-200"></div> */}
			<div className="h-full w-full bg-white px-4 flex flex-col justify-start gap-10">
				...
				<div className="text-center text-sm flex flex-col gap-7">
					...
					{tags && <p className="text-gray-500">{tags}</p>}
				</div>
