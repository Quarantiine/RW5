const ProductTypesCategory = ({ linkCategory }) => {
  return (
    <>
      <span
        onClick={() => linkCategory.current.scrollBy(-400, 0)}
        className="xl:hidden material-symbols-outlined text-5xl select-none flex cursor-pointer justify-center items-center absolute top-32 text-white border bg-black border-black z-[2] left-48 rounded-full hover:opacity-50"
      >
        arrow_left
      </span>
      <span
        onClick={() => linkCategory.current.scrollBy(400, 0)}
        className="xl:hidden material-symbols-outlined text-5xl select-none flex cursor-pointer justify-center items-center absolute top-32 text-white border bg-black border-black z-[2] right-3 rounded-full hover:opacity-50"
      >
        arrow_right
      </span>
      <div
        ref={linkCategory}
        className="link-category-6 xl:grid xl:grid-cols-4 flex gap-10 justify-start xl:justify-center items-center w-fit overflow-x-scroll overflow-y-hidden pr-10"
      >
