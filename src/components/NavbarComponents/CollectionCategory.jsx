const CollectionCategory = ({ linkCategory }) => {
  return (
    <>
      <span
      ...
      <div
        ref={linkCategory}
        className="link-category-5 xl:grid xl:grid-cols-4 flex gap-10 justify-start xl:justify-center items-center w-fit overflow-x-scroll overflow-y-hidden pr-10"
      >
