const BestSellersCategory = () => {
	return (
		<div className="flex xl:grid xl:grid-cols-4 gap-10 justify-start xl:justify-center items-center w-fit overflow-x-scroll overflow-y-hidden pr-10">
			<div className="link-img-container flex flex-col justify-center items-center gap-3">
				...
				<p className="hover:text-[#FABDBD] w-52 h-5 font-[times-new-roman] cursor-pointer">Biotin & Collagen Bundle</p>
			</div>
			<div className="link-img-container flex flex-col justify-center items-center gap-3">
				<div className="w-52 h-52 relative bg-pink-100 rounded-xl overflow-hidden mx-auto cursor-pointer flex justify-end items-start">
					<img
				...
				<p className="hover:text-[#FABDBD] w-52 h-5 font-[times-new-roman] cursor-pointer">Rose Oil Body Wash</p>
			</div>
			<div className="link-img-container flex flex-col justify-center items-center gap-3">
				<div className="w-52 h-52 relative bg-pink-100 rounded-xl overflow-hidden mx-auto cursor-pointer flex justify-end items-start">
					<img
				...
				<p className="hover:text-[#FABDBD] w-52 h-5 font-[times-new-roman] cursor-pointer">Color Brightening Bundle</p>
			</div>
			<div className="link-img-container flex flex-col justify-center items-center gap-3">
				<div className="w-52 h-52 relative bg-pink-100 rounded-xl overflow-hidden mx-auto cursor-pointer flex justify-end items-start">
					<img
				...
				<p className="hover:text-[#FABDBD] w-52 h-5 font-[times-new-roman] cursor-pointer">Keratin Bundle</p>
			</div>
			<div className="link-img-container flex flex-col justify-center items-center gap-3">
				<div className="w-52 h-52 relative bg-pink-100 rounded-xl overflow-hidden mx-auto cursor-pointer flex justify-end items-start">
					<img
			...
			<div className="link-img-container flex flex-col justify-center items-center gap-3">
				...
				<p className="hover:text-[#FABDBD] w-52 h-5 font-[times-new-roman] cursor-pointer">Hemp Oil Complex Bundle</p>
			</div>
			<div className="link-img-container flex flex-col justify-center items-center gap-3">
				<div className="w-52 h-52 relative bg-pink-100 rounded-xl overflow-hidden mx-auto cursor-pointer flex justify-end items-start">
					<img
