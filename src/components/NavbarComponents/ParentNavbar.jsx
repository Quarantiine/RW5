			...
			{shopDropDown && (
				...
				>
					<div className="flex gap-24 justify-center items-start w-[100%] h-full mx-auto">
						...
						{newArrivalsLink && <NewArrivalsCategory linkCategory={linkCategory} />}
						{newArrivalsLink2 && <BestSellersCategory linkCategory={linkCategory} />}
						{newArrivalsLink3 && <ValueSetsCategory linkCategory={linkCategory} />}
						{newArrivalsLink4 && <HairNeedsCategory linkCategory={linkCategory} />}
