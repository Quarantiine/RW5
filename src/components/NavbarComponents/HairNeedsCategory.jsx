	...
	return (
		<div className="xl:grid xl:grid-cols-4 flex gap-10 justify-start xl:justify-center items-center w-fit overflow-x-scroll overflow-y-hidden pr-10">
			<div className="link-img-container flex flex-col justify-center items-center gap-3">
				...
				<p className="hover:text-[#FABDBD] w-52 h-5 font-[times-new-roman] cursor-pointer">Intense Moisture</p>
			</div>
			<div className="link-img-container flex flex-col justify-center items-center gap-3">
				<div className="w-52 h-52 relative bg-pink-100 rounded-xl overflow-hidden mx-auto cursor-pointer flex justify-end items-start">
					<img
				...
				<p className="hover:text-[#FABDBD] w-52 h-5 font-[times-new-roman] cursor-pointer">More Volume</p>
			</div>
			<div className="link-img-container flex flex-col justify-center items-center gap-3">
				<div className="w-52 h-52 relative bg-pink-100 rounded-xl overflow-hidden mx-auto cursor-pointer flex justify-end items-start">
					<img
				...
				<p className="hover:text-[#FABDBD] w-52 h-5 font-[times-new-roman] cursor-pointer">Vibrant Color</p>
			</div>
			<div className="link-img-container flex flex-col justify-center items-center gap-3">
				<div className="w-52 h-52 relative bg-pink-100 rounded-xl overflow-hidden mx-auto cursor-pointer flex justify-end items-start">
					<img
				...
				<p className="hover:text-[#FABDBD] w-52 h-5 font-[times-new-roman] cursor-pointer">Clarify Scalp</p>
			</div>
			<div className="link-img-container flex flex-col justify-center items-center gap-3">
				<div className="w-52 h-52 relative bg-pink-100 rounded-xl overflow-hidden mx-auto cursor-pointer flex justify-end items-start">
					<img
				...
				<p className="hover:text-[#FABDBD] w-52 h-5 font-[times-new-roman] cursor-pointer">Defined Curl</p>
			</div>
			<div className="link-img-container flex flex-col justify-center items-center gap-3">
				<div className="w-52 h-52 relative bg-pink-100 rounded-xl overflow-hidden mx-auto cursor-pointer flex justify-end items-start">
					<img
				...
				<p className="hover:text-[#FABDBD] w-52 h-5 font-[times-new-roman] cursor-pointer">Tame Frizziness</p>
			</div>
		</div>
	);
};
